...
* File [an issue](https://github.com/LykkeCorp/aws-nuke-sources/issues/new) and describe
...
1. Check the [issues page](https://github.com/LykkeCorp/aws-nuke-sources/issues),
   whether someone already had the same or a similar idea.
2. Also check the [closed
   issues](https://github.com/LykkeCorp/aws-nuke-sources/issues?utf8=%E2%9C%93&q=is%3Aissue),
